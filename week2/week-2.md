...
### 2.readability.c
#### A program to help indicate the reading level of a user given texts, struggled with the final output but as to then realised I mistaken used int instead of float for the function that calculate the index, preventing the rounding from start.
