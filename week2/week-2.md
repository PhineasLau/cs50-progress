...
### String is actually just an array of characters, and each characters takes 1 byte of memory as a letter, but also holds an ACSII value. Therefore you can output the ACSII value of each character in a string by using printf and %i and referring the posistions of the characters in a string. And so you could compare characters like numbers as this will automatically refers to their ACSII value.
