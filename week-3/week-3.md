# Week 3
## Recursion
### Function that is to call itself repeatedly to break down the larger to smaller problem, as a loop to repeat itself after got handed the base input, until a base condition is met.
## Memory
