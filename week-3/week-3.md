# Week 3
## Recursion
### Function that is to call itself again under a condition based on a changing variable as the function runs, as a loop to repeat itself after got handed the base input.
## Memory
